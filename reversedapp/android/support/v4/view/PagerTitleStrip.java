...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    i10 = Math.max(Math.max(i8 + i6, i9 + j), i10 + i7);
    ...
    if (i8 != 16) {
      ...
      i3 = (paramInt - i3 - i4 - i10) / 2;
      paramInt = i6 + i3;
      j += i3;
      i3 += i7;
    } 
    this.mCurrText.layout(m, j, i5, this.mCurrText.getMeasuredHeight() + j);
    j = Math.min(i1, m - this.mScaledTextSpacing - i);
    this.mPrevText.layout(j, paramInt, i + j, this.mPrevText.getMeasuredHeight() + paramInt);
    paramInt = Math.max(n - i2 - k, i5 + this.mScaledTextSpacing);
    this.mNextText.layout(paramInt, i3, paramInt + k, this.mNextText.getMeasuredHeight() + i3);
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v4\view\PagerTitleStrip.class
