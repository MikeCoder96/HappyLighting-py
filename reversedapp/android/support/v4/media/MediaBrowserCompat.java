...
public final class MediaBrowserCompat {
    ...
    public void handleMessage(Message param1Message) {
      ...
      switch (param1Message.what) {
        default:
          ...
          return;
        case 3:
          ((MediaBrowserCompat.MediaBrowserServiceCallbackImpl)this.mCallbackImplRef.get()).onLoadChildren(this.mCallbacksMessengerRef.get(), stringBuilder.getString("data_media_item_id"), stringBuilder.getParcelableArrayList("data_media_item_list"), stringBuilder.getBundle("data_options"));
          return;
        case 2:
      ...
      ((MediaBrowserCompat.MediaBrowserServiceCallbackImpl)this.mCallbackImplRef.get()).onServiceConnected(this.mCallbacksMessengerRef.get(), stringBuilder.getString("data_media_item_id"), (MediaSessionCompat.Token)stringBuilder.getParcelable("data_media_session_token"), stringBuilder.getBundle("data_root_hints"));
    }
  ...
  static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
    ...
    public void onLoadChildren(Messenger param1Messenger, String param1String, List<MediaBrowserCompat.MediaItem> param1List, Bundle param1Bundle) {
      ...
      MediaBrowserCompat.SubscriptionCallback subscriptionCallback = stringBuilder.getCallback(param1Bundle);
    ...
    public void connect() {
      if (this.mState == 0) {
        if (!MediaBrowserCompat.DEBUG || this.mServiceConnection == null) {
          if (this.mServiceBinderWrapper == null) {
            if (this.mCallbacksMessenger == null) {
              ...
              try {
                ...
                stringBuilder4.append("Failed binding to service ");
                stringBuilder4.append(this.mServiceComponent);
                Log.e("MediaBrowserCompat", stringBuilder4.toString());
                bool = false;
              } 
              if (!bool)
                this.mHandler.post(new Runnable() {
            ...
            stringBuilder3.append(this.mCallbacksMessenger);
          ...
          stringBuilder2.append(this.mServiceBinderWrapper);
          throw new RuntimeException(stringBuilder2.toString());
        } 
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("mServiceConnection should be null. Instead it is ");
        stringBuilder1.append(this.mServiceConnection);
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v4\media\MediaBrowserCompat.class
