...
public final class TimeUtils {
  ...
  private static int formatDurationLocked(long paramLong, int paramInt) {
    ...
    if (paramInt != 0) {
      ...
      k += accumField(bool2, 1, bool3, 2);
      if (k > 0) {
        bool3 = true;
      } else {
        bool3 = false;
      } 
      int i1 = k + accumField(n, 1, bool3, 2);
      if (i1 > 0) {
        k = 3;
      } else {
        k = 0;
      } 
      i1 += accumField(j, 2, true, k) + 1;
      k = 0;
      while (true) {
        b = k;
        if (i1 < paramInt) {
    ...
    m = printField(arrayOfChar, bool1, 'h', m, bool3, k);
    if (m != i) {
      bool3 = true;
    } else {
      bool3 = false;
    ...
    m = printField(arrayOfChar, bool2, 'm', m, bool3, k);
    if (m != i) {
      bool3 = true;
    } else {
      bool3 = false;
    ...
    k = printField(arrayOfChar, n, 's', m, bool3, k);
    if (paramInt != 0 && k != i) {
      paramInt = 3;
    } else {
      paramInt = 0;
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v\\util\TimeUtils.class
