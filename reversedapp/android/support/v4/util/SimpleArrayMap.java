...
public class SimpleArrayMap<K, V> {
  ...
  public V put(K paramK, V paramV) {
    ...
    if (m < i) {
      ...
      j = m + 1;
      System.arraycopy(arrayOfInt1, m, arrayOfInt2, j, i - m);
    ...
    if (j <= 1) {
      ...
      if (n > 8 && this.mSize < this.mHashes.length / 3) {
        ...
        if (paramInt < m) {
          ...
          int[] arrayOfInt1 = this.mHashes;
          n = m - paramInt;
          System.arraycopy(arrayOfInt2, k, arrayOfInt1, paramInt, n);
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v\\util\SimpleArrayMap.class
