...
class ViewBoundsCheck {
  ...
  static class BoundFlags {
    ...
    boolean boundsMatch() {
      return ((this.mBoundFlags & 0x7) != 0 && (this.mBoundFlags & compare(this.mChildStart, this.mRvStart) << 0) == 0) ? false : (((this.mBoundFlags & 0x70) != 0 && (this.mBoundFlags & compare(this.mChildStart, this.mRvEnd) << 4) == 0) ? false : (((this.mBoundFlags & 0x700) != 0 && (this.mBoundFlags & compare(this.mChildEnd, this.mRvStart) << 8) == 0) ? false : (!((this.mBoundFlags & 0x7000) != 0 && (this.mBoundFlags & compare(this.mChildEnd, this.mRvEnd) << 12) == 0))));
    }
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v7\widget\ViewBoundsCheck.class
