...
class ChildHelper {
  ...
  static class Bucket {
    ...
    int countOnesBefore(int param1Int) {
      return (this.mNext == null) ? ((param1Int >= 64) ? Long.bitCount(this.mData) : Long.bitCount(this.mData & (1L << param1Int) - 1L)) : ((param1Int < 64) ? Long.bitCount(this.mData & (1L << param1Int) - 1L) : (this.mNext.countOnesBefore(param1Int - 64) + Long.bitCount(this.mData)));
    }
...
/* Location:              C:\Users\mikel\Desktop\Projects\LEDStripController\HappyLighting_base-dex2jar.jar!\android\support\v7\widget\ChildHelper.class
